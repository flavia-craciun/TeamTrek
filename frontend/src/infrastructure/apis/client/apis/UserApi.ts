...
export interface ApiUserAddMembersPostRequest {
...
export interface ApiUserDeleteMembersDeleteRequest {
    email: Array<string>;
    teamName: string;
}
...
export class UserApi extends runtime.BaseAPI {
    ...
    /**
     */
    async apiUserAddMembersPostRaw(requestParameters: ApiUserAddMembersPostRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponse>> {
        ...
        const response = await this.request({
            path: `/api/User/AddMembers`,
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: MembersDTOToJSON(requestParameters.membersDTO),
        }, initOverrides);
    ...
    /**
     */
    async apiUserAddMembersPost(requestParameters: ApiUserAddMembersPostRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RequestResponse> {
        const response = await this.apiUserAddMembersPostRaw(requestParameters, initOverrides);
    ...
    /**
     */
    async apiUserDeleteMembersDeleteRaw(requestParameters: ApiUserDeleteMembersDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RequestResponse>> {
        if (requestParameters.email === null || requestParameters.email === undefined) {
            throw new runtime.RequiredError('email','Required parameter requestParameters.email was null or undefined when calling apiUserDeleteMembersDelete.');
        }

        if (requestParameters.teamName === null || requestParameters.teamName === undefined) {
            throw new runtime.RequiredError('teamName','Required parameter requestParameters.teamName was null or undefined when calling apiUserDeleteMembersDelete.');
        }
        ...
        const response = await this.request({
            path: `/api/User/DeleteMembers`.replace(`{${"Email"}}`, encodeURIComponent(String(requestParameters.email))).replace(`{${"TeamName"}}`, encodeURIComponent(String(requestParameters.teamName))),
            method: 'DELETE',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    /**
     */
    async apiUserDeleteMembersDelete(requestParameters: ApiUserDeleteMembersDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RequestResponse> {
        const response = await this.apiUserDeleteMembersDeleteRaw(requestParameters, initOverrides);
        return await response.value();
    }
